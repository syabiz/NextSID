...
1. **Clone Repositori:**
```bash
   git clone [https://github.com/syabiz/NextSID.git](https://github.com/syabiz/NextSID.git)
   cd NextSID
...
Silakan buka bagian Issues jika Anda menemukan kendala selama pengujian versi Alpha ini.
